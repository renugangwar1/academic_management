  ...
  <td>
      {{ $student->appearingCourses->pluck('course_code')->filter()->implode(', ') ?: 'N/A' }}
            ...
            <div class="important-note bold">
                <p><strong style="text-decoration:underline;">IMPORTANT:</strong> The Principal may issue this ticket after verifying eligibility and attesting the photo and signature of the candidate.</p>
            </div>
            ...
            <div class="instructions bold">
                ...
                <ol class="instruction-list">
                    ...
                    <li>During the examination, candidates may be checked for prohibited items. If found, they will be debarred and/or face disciplinary action.</li>
                </ol>
