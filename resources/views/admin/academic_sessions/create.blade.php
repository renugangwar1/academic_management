            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div>
                    ...
                    <p class="text-muted small mb-0">
                        {{ isset($academic_session) ? 'Update the existing academic session details.' : 'Create a new academic session for program tracking.' }}
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-body p-4">
            <form action="{{ isset($academic_session) 
                ...
                {{-- Semester Type (for Regular) --}}
                <div class="mb-3 d-none" id="semesterField">
                    <label class="form-label fw-semibold">Semester Type</label>
                    <select name="odd_even" class="form-select @error('odd_even') is-invalid @enderror" id="oddEvenSelect">
                ...
                {{-- Diploma Year (for Diploma) --}}
                <div class="mb-3 d-none" id="diplomaYearField">
                    <label class="form-label fw-semibold">Diploma Year</label>
                    <select name="diploma_year" class="form-select @error('diploma_year') is-invalid @enderror" id="diplomaYearSelect">
                ...
                {{-- Active --}}
                <div class="mb-3">
                    <label class="form-label fw-semibold">Active Session</label>
                ...
                <div class="d-flex gap-2 mt-4">
                    ...
                    <a href="{{ route('admin.academic_sessions.index') }}" class="btn btn-outline-secondary">Cancel</a>
                </div>
