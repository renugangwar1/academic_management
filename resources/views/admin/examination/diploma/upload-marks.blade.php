...
<div class="container py-4">
    ...
    <div class="card border-primary mb-4">
        ...
        <div class="card-body">
            <form id="uploadForm"
                  action="{{ route('admin.diploma.exams.upload-marks.file') }}"
                  method="POST"
    ...
    <div class="card border-secondary mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.diploma.exams.download-uploaded-marks') }}">
                @csrf
    ...
    <div class="card border-dark">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.diploma.exams.compile.internal') }}">
                @csrf
    ...
    {{-- ========== Preview Table ========== --}}
    @if(count($preview))
        <form method="POST" action="{{ route('admin.diploma.exams.finalize.marks') }}">
            @csrf
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateDownloadLink() {
            ...
            if (sessionId && programId && semester && markType) {
                const url = `{{ route('admin.diploma.exams.template') }}?session_id=${sessionId}&program_id=${programId}&semester=${semester}&mark_type=${markType}`;
