...
{
    return Student::with('institute', 'courses', 'academicSession')
        ...
        ->map(function ($stu) {
           ...
           'Academic Session' => $stu->academicSession
    ? $stu->academicSession->year . ' (' . $stu->academicSession->term . ')'
    : 'N/A',
    ...
    public function headings(): array
    {
        return [
          ...
          'Academic Session', 'Email', 'Mobile', 'Date of Birth',
